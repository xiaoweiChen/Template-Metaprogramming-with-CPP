...
\begin{document}
	\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
		...
		\subsubsection*{\zihao{3} 5.5.\hspace{0.2cm}探索标准的类型特征}
		\addcontentsline{toc}{subsubsection}{5.5.\hspace{0.2cm}探索标准的类型特征}
		\subfile{content/2/chapter5/5.tex}
		
		\subsubsection*{\zihao{3} 5.6.\hspace{0.2cm}实际使用中使用类型特征的例子}
		\addcontentsline{toc}{subsubsection}{5.6.\hspace{0.2cm}实际使用中使用类型特征的例子}
