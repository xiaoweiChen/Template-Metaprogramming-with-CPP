...
\begin{document}
	\begin{sloppypar} %latex中一行文字出现溢出问题的解决方法
		...
		\color{white}
		\section*{\zihao{1}第一部分：Core Template Concepts}
		\pagecolor{mygray}
		\addcontentsline{toc}{section}{第一部分：Core Template Concepts}
		\textbf{\subfile{content/1/section.tex}}
		\newpage
		\color{black}
		\pagecolor{white}
		
		\subsection*{\zihao{2} 第1章\hspace{0.5cm}An Introduction to Templates}
		\addcontentsline{toc}{subsection}{第1章\hspace{0.5cm}An Introduction to Templates}
		\subfile{content/1/chapter1/0.tex}
		
		\subsubsection*{\zihao{3} 1.1.\hspace{0.2cm}Understanding the need for templates}
		\addcontentsline{toc}{subsubsection}{1.1.\hspace{0.2cm}Understanding the need for templates}
		\subfile{content/1/chapter1/1.tex}
		
		\subsubsection*{\zihao{3} 1.2.\hspace{0.2cm}Writing your first templates}
		\addcontentsline{toc}{subsubsection}{1.2.\hspace{0.2cm}Writing your first templates}
		\subfile{content/1/chapter1/2.tex}
		
		\subsubsection*{\zihao{3} 1.3.\hspace{0.2cm}Understanding template terminology}
		\addcontentsline{toc}{subsubsection}{1.3.\hspace{0.2cm}Understanding template terminology}
		\subfile{content/1/chapter1/3.tex}
		
		\subsubsection*{\zihao{3} 1.4.\hspace{0.2cm}A brief history of templates}
		\addcontentsline{toc}{subsubsection}{1.4.\hspace{0.2cm}A brief history of templates}
		\subfile{content/1/chapter1/4.tex}
		
		\subsubsection*{\zihao{3} 1.5.\hspace{0.2cm}The pros and cons of templates}
		\addcontentsline{toc}{subsubsection}{1.5.\hspace{0.2cm}The pros and cons of templates}
		...
		\subsection*{\zihao{2} 第2章\hspace{0.5cm}Template Fundamentals}
		\addcontentsline{toc}{subsection}{第2章\hspace{0.5cm}Template Fundamentals}
		\subfile{content/1/chapter2/0.tex}
		
		\subsubsection*{\zihao{3} 2.1.\hspace{0.2cm}Defining function templates}
		\addcontentsline{toc}{subsubsection}{2.1.\hspace{0.2cm}Defining function templates}
		\subfile{content/1/chapter2/1.tex}
		
		\subsubsection*{\zihao{3} 2.2.\hspace{0.2cm}Defining class templates}
		\addcontentsline{toc}{subsubsection}{2.2.\hspace{0.2cm}Defining class templates}
		\subfile{content/1/chapter2/2.tex}
		
		\subsubsection*{\zihao{3} 2.3.\hspace{0.2cm}Defining member function templates}
		\addcontentsline{toc}{subsubsection}{2.3.\hspace{0.2cm}Defining member function templates}
		\subfile{content/1/chapter2/3.tex}
		
		\subsubsection*{\zihao{3} 2.4.\hspace{0.2cm}Understanding template parameters}
		\addcontentsline{toc}{subsubsection}{2.4.\hspace{0.2cm}Understanding template parameters}
		\subfile{content/1/chapter2/4.tex}
		
		\subsubsection*{\zihao{3} 2.5.\hspace{0.2cm}Understanding template instantiation}
		\addcontentsline{toc}{subsubsection}{2.5.\hspace{0.2cm}Understanding template instantiation}
		\subfile{content/1/chapter2/5.tex}
		
		\subsubsection*{\zihao{3} 2.6.\hspace{0.2cm}Understanding template specialization}
		\addcontentsline{toc}{subsubsection}{2.6.\hspace{0.2cm}Understanding template specialization}
		\subfile{content/1/chapter2/6.tex}
		
		\subsubsection*{\zihao{3} 2.7.\hspace{0.2cm}Defining variable templates}
		\addcontentsline{toc}{subsubsection}{2.7.\hspace{0.2cm}Defining variable templates}
		\subfile{content/1/chapter2/7.tex}
		
		\subsubsection*{\zihao{3} 2.8.\hspace{0.2cm}Defining alias templates}
		\addcontentsline{toc}{subsubsection}{2.8.\hspace{0.2cm}Defining alias templates}
		\subfile{content/1/chapter2/8.tex}
		
		\subsubsection*{\zihao{3} 2.9.\hspace{0.2cm}Exploring generic lambdas and lambda templates}
		\addcontentsline{toc}{subsubsection}{2.9.\hspace{0.2cm}Exploring generic lambdas and lambda templates}
		...
		\subsection*{\zihao{2} 第3章\hspace{0.5cm}Variadic Templates}
		\addcontentsline{toc}{subsection}{第3章\hspace{0.5cm}Variadic Templates}
		\subfile{content/1/chapter3/0.tex}
		
		\subsubsection*{\zihao{3} 3.1.\hspace{0.2cm}Understanding the need for variadic templates}
		\addcontentsline{toc}{subsubsection}{3.1.\hspace{0.2cm}Understanding the need for variadic templates}
		\subfile{content/1/chapter3/1.tex}
		
		\subsubsection*{\zihao{3} 3.2.\hspace{0.2cm}Variadic function templates}
		\addcontentsline{toc}{subsubsection}{3.2.\hspace{0.2cm}Variadic function templates}
		\subfile{content/1/chapter3/2.tex}
		
		\subsubsection*{\zihao{3} 3.3.\hspace{0.2cm}Parameter packs}
		\addcontentsline{toc}{subsubsection}{3.3.\hspace{0.2cm}Parameter packs}
		\subfile{content/1/chapter3/3.tex}
		
		\subsubsection*{\zihao{3} 3.4.\hspace{0.2cm}Variadic class templates}
		\addcontentsline{toc}{subsubsection}{3.4.\hspace{0.2cm}Variadic class templates}
		\subfile{content/1/chapter3/4.tex}
		
		\subsubsection*{\zihao{3} 3.5.\hspace{0.2cm}Fold expressions}
		\addcontentsline{toc}{subsubsection}{3.5.\hspace{0.2cm}Fold expressions}
		\subfile{content/1/chapter3/5.tex}
		
		\subsubsection*{\zihao{3} 3.6.\hspace{0.2cm}Variadic alias templates}
		\addcontentsline{toc}{subsubsection}{3.6.\hspace{0.2cm}Variadic alias templates}
		\subfile{content/1/chapter3/6.tex}
		
		\subsubsection*{\zihao{3} 3.7.\hspace{0.2cm}Variadic variable templates}
		\addcontentsline{toc}{subsubsection}{3.7.\hspace{0.2cm}Variadic variable templates}
		...
		\color{white}
		\section*{\zihao{1}第二部分：Advanced Template Features}
		\pagecolor{mygray}
		\addcontentsline{toc}{section}{第二部分：Advanced Template Features}
		\textbf{\subfile{content/2/section.tex}}
		\newpage
		\color{black}
		\pagecolor{white}
		
		\subsection*{\zihao{2} 第4章\hspace{0.5cm}Advanced Template Concepts}
		\addcontentsline{toc}{subsection}{第4章\hspace{0.5cm}Advanced Template Concepts}
		\subfile{content/2/chapter4/0.tex}
		
		\subsubsection*{\zihao{3} 4.1.\hspace{0.2cm}Understanding name binding and dependent names}
		\addcontentsline{toc}{subsubsection}{4.1.\hspace{0.2cm}Understanding name binding and dependent names}
		\subfile{content/2/chapter4/1.tex}
		
		\subsubsection*{\zihao{3} 4.2.\hspace{0.2cm}Exploring template recursion}
		\addcontentsline{toc}{subsubsection}{4.2.\hspace{0.2cm}Exploring template recursion}
		\subfile{content/2/chapter4/2.tex}
		
		\subsubsection*{\zihao{3} 4.3.\hspace{0.2cm}Function template argument deduction}
		\addcontentsline{toc}{subsubsection}{4.3.\hspace{0.2cm}Function template argument deduction}
		\subfile{content/2/chapter4/3.tex}
		
		\subsubsection*{\zihao{3} 4.4.\hspace{0.2cm}Class template argument deduction}
		\addcontentsline{toc}{subsubsection}{4.4.\hspace{0.2cm}Class template argument deduction}
		\subfile{content/2/chapter4/4.tex}
		
		\subsubsection*{\zihao{3} 4.5.\hspace{0.2cm}Forwarding references}
		\addcontentsline{toc}{subsubsection}{4.5.\hspace{0.2cm}Forwarding references}
		\subfile{content/2/chapter4/5.tex}
		
		\subsubsection*{\zihao{3} 4.6.\hspace{0.2cm}The decltype specifier}
		\addcontentsline{toc}{subsubsection}{4.6.\hspace{0.2cm}The decltype specifier}
		\subfile{content/2/chapter4/6.tex}
		
		\subsubsection*{\zihao{3} 4.7.\hspace{0.2cm}The std::declval type operator}
		\addcontentsline{toc}{subsubsection}{4.7.\hspace{0.2cm}The std::declval type operator}
		\subfile{content/2/chapter4/7.tex}
		
		\subsubsection*{\zihao{3} 4.8.\hspace{0.2cm}Understanding friendship in templates}
		\addcontentsline{toc}{subsubsection}{4.8.\hspace{0.2cm}Understanding friendship in templates}
		...
		\subsection*{\zihao{2} 第5章\hspace{0.5cm}Type Traits and Conditional Compilation}
		\addcontentsline{toc}{subsection}{第5章\hspace{0.5cm}Type Traits and Conditional Compilation}
		\subfile{content/2/chapter5/0.tex}
		
		\subsubsection*{\zihao{3} 5.1.\hspace{0.2cm}Understanding and defining type traits}
		\addcontentsline{toc}{subsubsection}{5.1.\hspace{0.2cm}Understanding and defining type traits}
		\subfile{content/2/chapter5/1.tex}
		
		\subsubsection*{\zihao{3} 5.2.\hspace{0.2cm}Exploring SFINAE and its purpose}
		\addcontentsline{toc}{subsubsection}{5.2.\hspace{0.2cm}Exploring SFINAE and its purpose}
		\subfile{content/2/chapter5/2.tex}
		
		\subsubsection*{\zihao{3} 5.3.\hspace{0.2cm}Enabling SFINAE with the enable\_if type trait}
		\addcontentsline{toc}{subsubsection}{5.3.\hspace{0.2cm}Enabling SFINAE with the enable\_if type trait}
		\subfile{content/2/chapter5/3.tex}
		
		\subsubsection*{\zihao{3} 5.4.\hspace{0.2cm}Using constexpr if}
		\addcontentsline{toc}{subsubsection}{5.4.\hspace{0.2cm}Using constexpr if}
		\subfile{content/2/chapter5/4.tex}
		
		\subsubsection*{\zihao{3} 5.5.\hspace{0.2cm}Exploring the standard type traits}
		\addcontentsline{toc}{subsubsection}{5.5.\hspace{0.2cm}Exploring the standard type traits}
		\subfile{content/2/chapter5/5.tex}
		
		\subsubsection*{\zihao{3} 5.6.\hspace{0.2cm}Seeing real-world examples of using type traits}
		\addcontentsline{toc}{subsubsection}{5.6.\hspace{0.2cm}Seeing real-world examples of using type traits}
		...
		\subsection*{\zihao{2} 第6章\hspace{0.5cm}Concepts and Constraints}
		\addcontentsline{toc}{subsection}{第6章\hspace{0.5cm}Concepts and Constraints}
		\subfile{content/2/chapter6/0.tex}
		
		\subsubsection*{\zihao{3} 6.1.\hspace{0.2cm}Understanding the need for concep}
		\addcontentsline{toc}{subsubsection}{6.1.\hspace{0.2cm}Understanding the need for concep}
		\subfile{content/2/chapter6/1.tex}
		
		\subsubsection*{\zihao{3} 6.2.\hspace{0.2cm}Defining concepts}
		\addcontentsline{toc}{subsubsection}{6.2.\hspace{0.2cm}Defining concepts}
		\subfile{content/2/chapter6/2.tex}
		
		\subsubsection*{\zihao{3} 6.3.\hspace{0.2cm}Exploring requires expressions}
		\addcontentsline{toc}{subsubsection}{6.3.\hspace{0.2cm}Exploring requires expressions}
		\subfile{content/2/chapter6/3.tex}
		
		\subsubsection*{\zihao{3} 6.4.\hspace{0.2cm}Composing constraints}
		\addcontentsline{toc}{subsubsection}{6.4.\hspace{0.2cm}Composing constraints}
		\subfile{content/2/chapter6/4.tex}
		
		\subsubsection*{\zihao{3} 6.5.\hspace{0.2cm}Learning about the ordering of templates with constraints}
		\addcontentsline{toc}{subsubsection}{6.5.\hspace{0.2cm}Learning about the ordering of templates with constraints}
		\subfile{content/2/chapter6/5.tex}
		
		\subsubsection*{\zihao{3} 6.6.\hspace{0.2cm}Constraining non-template member functions}
		\addcontentsline{toc}{subsubsection}{6.6.\hspace{0.2cm}Constraining non-template member functions}
		\subfile{content/2/chapter6/6.tex}
		
		\subsubsection*{\zihao{3} 6.7.\hspace{0.2cm}Constraining class templates}
		\addcontentsline{toc}{subsubsection}{6.7.\hspace{0.2cm}Constraining class templates}
		\subfile{content/2/chapter6/7.tex}
		
		\subsubsection*{\zihao{3} 6.8.\hspace{0.2cm}Constraining variable templates and template aliases}
		\addcontentsline{toc}{subsubsection}{6.8.\hspace{0.2cm}Constraining variable templates and template aliases}
		\subfile{content/2/chapter6/8.tex}
		
		\subsubsection*{\zihao{3} 6.9.\hspace{0.2cm}Learning more ways to specify constraints}
		\addcontentsline{toc}{subsubsection}{6.9.\hspace{0.2cm}Learning more ways to specify constraints}
		\subfile{content/2/chapter6/9.tex}
		
		\subsubsection*{\zihao{3} 6.10.\hspace{0.2cm}Using concepts to constrain auto parameters}
		\addcontentsline{toc}{subsubsection}{6.10.\hspace{0.2cm}Using concepts to constrain auto parameters}
		\subfile{content/2/chapter6/10.tex}
		
		\subsubsection*{\zihao{3} 6.11.\hspace{0.2cm}总结}
		\addcontentsline{toc}{subsubsection}{6.11.\hspace{0.2cm}总结}
		\subfile{content/2/chapter6/11.tex}
		
		\subsubsection*{\zihao{3} 6.12.\hspace{0.2cm}习题}
		\addcontentsline{toc}{subsubsection}{6.12.\hspace{0.2cm}习题}
		\subfile{content/2/chapter6/12.tex}
		
		\subsubsection*{\zihao{3} 6.13.\hspace{0.2cm}扩展阅读}
		\addcontentsline{toc}{subsubsection}{6.13.\hspace{0.2cm}扩展阅读}
		\subfile{content/2/chapter6/13.tex}
		\newpage
		
		\color{white}
		\section*{\zihao{1}第三部分：Applied Templates}
		\pagecolor{mygray}
		\addcontentsline{toc}{section}{第三部分：Applied Templates}
		\textbf{\subfile{content/3/section.tex}}
		\newpage
		\color{black}
		\pagecolor{white}
		
		\subsection*{\zihao{2} 第7章\hspace{0.5cm}Patterns and Idioms}
		\addcontentsline{toc}{subsection}{第7章\hspace{0.5cm}Patterns and Idioms}
		...
		\subsection*{\zihao{2} 第8章\hspace{0.5cm}Ranges and Algorithms}
		\addcontentsline{toc}{subsection}{第8章\hspace{0.5cm}Ranges and Algorithms}
		...
		\subsection*{\zihao{2} 第9章\hspace{0.5cm}The Ranges Library}
		\addcontentsline{toc}{subsection}{第9章\hspace{0.5cm}The Ranges Library}
		...
		\section*{\zihao{1}Appendix Closing Notes}
		\addcontentsline{toc}{section}{Appendix Closing Notes}
		\textbf{\subfile{content/4/0.tex}}
		\newpage
		
		\section*{\zihao{1}Assignment Answers}
		\addcontentsline{toc}{section}{Assignment Answers}
		
		\subsection*{\zihao{2} Chapter 1, Introduction to Templates}
		\addcontentsline{toc}{subsection}{Chapter 1, Introduction to Templates}
		\subfile{content/5/1.tex}
		
		\subsection*{\zihao{2} Chapter 2, Template Fundamentals}
		\addcontentsline{toc}{subsection}{Chapter 2, Template Fundamentals}
		\subfile{content/5/2.tex}
		
		\subsection*{\zihao{2} Chapter 3, Variadic Templates}
		\addcontentsline{toc}{subsection}{Chapter 3, Variadic Templates}
		\subfile{content/5/3.tex}
		
		\subsection*{\zihao{2} Chapter 4, Advanced Template Concepts}
		\addcontentsline{toc}{subsection}{Chapter 4, Advanced Template Concepts}
		\subfile{content/5/4.tex}
		
		\subsection*{\zihao{2} Chapter 5, Type Traits and Conditional Compilation}
		\addcontentsline{toc}{subsection}{Chapter 5, Type Traits and Conditional Compilation}
		\subfile{content/5/2.tex}
		
		\subsection*{\zihao{2} Chapter 6, Concepts and Constraints}
		\addcontentsline{toc}{subsection}{Chapter 6, Concepts and Constraints}
		\subfile{content/5/2.tex}
		
		\subsection*{\zihao{2} Chapter 7, Patterns and Idioms}
		\addcontentsline{toc}{subsection}{Chapter 7, Patterns and Idioms}
		\subfile{content/5/2.tex}
		
		\subsection*{\zihao{2} Chapter 8, Ranges and Algorithms}
		\addcontentsline{toc}{subsection}{Chapter 8, Ranges and Algorithms}
		\subfile{content/5/2.tex}
		
		\subsection*{\zihao{2} Chapter 9, The Ranges Library}
		\addcontentsline{toc}{subsection}{Chapter 9, The Ranges Library}
		\subfile{content/5/2.tex}
